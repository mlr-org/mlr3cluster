...
[TaskClust](https://mlr3cluster.mlr-org.com/reference/TaskClust.md) only
contains the numeric features `x1`, ..., `xd`; the cluster membership is
not stored in the task. The parameters are initialized to `k = 3`,
`d = 2`, `sd = 1`, and `center_box = 10`.
...
#>  - attr(*, ".internal.selfref")=<pointer: 0x560f88013a30> 
