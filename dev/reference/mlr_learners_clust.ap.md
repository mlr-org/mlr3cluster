...
learner$train(task)
#> Error in .__ParamSet__get_values(self = self, private = private, super = super,     class = class, tags = tags, any_tags = any_tags, type = type,     check_required = check_required, remove_dependencies = remove_dependencies): Missing required parameters: s
...
#> Error: Cannot predict, Learner 'clust.ap' has not been trained yet
