...
The key is `moons_clust` and not `moons`, because
[mlr3::mlr_task_generators](https://mlr3.mlr-org.com/reference/mlr_task_generators.html)
already provides a classification generator under the key `moons`.
...
[tgen()](https://mlr3.mlr-org.com/reference/mlr_sugar.html):
    ...
    mlr_task_generators$get("moons_clust")
    tgen("moons_clust")
...
- [`TaskGeneratorMoonsClust$new()`](#method-TaskGeneratorMoonsClust-initialize)

- [`TaskGeneratorMoonsClust$plot()`](#method-TaskGeneratorMoonsClust-plot)

- [`TaskGeneratorMoonsClust$clone()`](#method-TaskGeneratorMoonsClust-clone)
...
### `TaskGeneratorMoonsClust$plot()`

Creates a simple plot of generated data, colored by cluster membership.

#### Usage

    TaskGeneratorMoonsClust$plot(n = 200L, pch = 19L, ...)
...
### `TaskGeneratorMoonsClust$clone()`

The objects of this class are cloneable with this method.

#### Usage

    TaskGeneratorMoonsClust$clone(deep = FALSE)
