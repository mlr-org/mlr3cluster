...
Fichtenberger, Hendrik, Gille, Marc, Schmidt, Melanie, Schwiegelshohn,
Chris, Sohler, Christian (2013). “BICO: BIRCH Meets Coresets for k-Means
Clustering.” In *Algorithms–ESA 2013: 21st Annual European Symposium,
Sophia Antipolis, France, September 2-4, 2013. Proceedings 21*, 481–492.
Springer.
...
- [`LearnerClustBICO$new()`](#method-LearnerClustBICO-initialize)

- [`LearnerClustBICO$clone()`](#method-LearnerClustBICO-clone)
